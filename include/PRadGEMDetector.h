...
public:
    ...
    std::vector<GEMCluster> &GetCluster() {return gem_clusters;};
    const std::vector<GEMCluster> &GetCluster() const {return gem_clusters;};
...
private:
    ...
    std::vector<GEMCluster> gem_clusters;
};
